...
void speedCheck() {
  ...
  if (buttonBPress == 1) {
    speedIncrease = ballSpeed / 20;        //increase ballSpeed by 5% if in good zone
    ballSpeed = ballSpeed - speedIncrease;
  }
  if (buttonBPress == 2) {
    speedIncrease = ballSpeed / 10;        //increase ballSpeed by 10% if in great zone
    ballSpeed = ballSpeed - speedIncrease;
  }
  if (buttonBPress == 3) {
    speedIncrease = ballSpeed / 10;        //decrease ballSpeed by 10% if in late zone
    ballSpeed = ballSpeed + speedIncrease;
  }
}
